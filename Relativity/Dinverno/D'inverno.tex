...
\begin{document}
          ...
          \section{K-calculus}
               ...
               \begin{callout}
                    ...
                    \end{itemize}
               \end{callout}
               \textbf{Galilean Transformation:} \textit{Q:} Are the laws of physics the same for all observers ir are there preferred states of motion, preferred refrence systems, and so on?\textit{A:} Newton's theory postulates the existence of preferred frames of reference. The existence of this is essentially implied by the first law:
               \begin{callout}
               ...
               \begin{equation}
                    ...
                    \end{pmatrix}t
               \end{equation}
               where $t$ is the time in both frames since in Newton's theory we can assume absolute time. From a mathematical viewpoint this means that Newton's laws mus be \hldb{invariant} under a Galilean Transformation.
